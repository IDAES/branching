...
void bind_submodule(py::module_ const& m) {
	...
	// Selin Added
	// Node bipartite candidate observation
	auto node_bipartite_cand_obs =
		ecole::python::auto_class<NodeBipartiteCandObs>(m, "NodeBipartiteCandObs", R"(
		Bipartite graph observation for branch-and-bound nodes.
		...
		Each edge is associated with the coefficient of the variable in the constraint.
			...
			.def_readwrite_xtensor(
				"column_features",
				&NodeBipartiteCandObs::column_features,
				"A matrix where each row is represents a variable, and each column a feature of the variables.");

	py::enum_<NodeBipartiteCandObs::ColumnFeatures>(node_bipartite_obs, "ColumnFeatures")
		.value("objective", NodeBipartiteCandObs::ColumnFeatures::objective)
		.value("is_type_binary", NodeBipartiteCandObs::ColumnFeatures::is_type_binary)
		.value("is_type_integer", NodeBipartiteCandObs::ColumnFeatures::is_type_integer)
		.value("is_type_implicit_integer", NodeBipartiteCandObs::ColumnFeatures::is_type_implicit_integer)
		.value("is_type_continuous", NodeBipartiteCandObs::ColumnFeatures::is_type_continuous)
		.value("has_lower_bound", NodeBipartiteCandObs::ColumnFeatures::has_lower_bound)
		.value("has_upper_bound", NodeBipartiteCandObs::ColumnFeatures::has_upper_bound)
		.value("normed_reduced_cost", NodeBipartiteCandObs::ColumnFeatures::normed_reduced_cost)
		.value("solution_value", NodeBipartiteCandObs::ColumnFeatures::solution_value)
		.value("solution_frac", NodeBipartiteCandObs::ColumnFeatures::solution_frac)
		.value("is_solution_at_lower_bound", NodeBipartiteCandObs::ColumnFeatures::is_solution_at_lower_bound)
		.value("is_solution_at_upper_bound", NodeBipartiteCandObs::ColumnFeatures::is_solution_at_upper_bound)
		.value("scaled_age", NodeBipartiteCandObs::ColumnFeatures::scaled_age)
		.value("incumbent_value", NodeBipartiteCandObs::ColumnFeatures::incumbent_value)
		.value("average_incumbent_value", NodeBipartiteCandObs::ColumnFeatures::average_incumbent_value)
		.value("is_basis_lower", NodeBipartiteCandObs::ColumnFeatures::is_basis_lower)
		.value("is_basis_basic", NodeBipartiteCandObs::ColumnFeatures::is_basis_basic)
		.value("is_basis_upper", NodeBipartiteCandObs::ColumnFeatures::is_basis_upper)
		.value("is_basis_zero", NodeBipartiteCandObs::ColumnFeatures::is_basis_zero)
		.value("solution_infeasibility", NodeBipartiteCandObs::ColumnFeatures::solution_infeasibility)
		.value("edge_mean", NodeBipartiteCandObs::ColumnFeatures::edge_mean)
		.value("edge_min", NodeBipartiteCandObs::ColumnFeatures::edge_min)
		.value("edge_max", NodeBipartiteCandObs::ColumnFeatures::edge_max)
		.value("bias_mean", NodeBipartiteCandObs::ColumnFeatures::bias_mean)
		.value("bias_min", NodeBipartiteCandObs::ColumnFeatures::bias_min)
		.value("bias_max", NodeBipartiteCandObs::ColumnFeatures::bias_max)
		.value("obj_cos_sim_mean", NodeBipartiteCandObs::ColumnFeatures::obj_cos_sim_mean)
		.value("obj_cos_sim_min", NodeBipartiteCandObs::ColumnFeatures::obj_cos_sim_min)
		.value("obj_cos_sim_max", NodeBipartiteCandObs::ColumnFeatures::obj_cos_sim_max)
		.value("is_tight_mean", NodeBipartiteCandObs::ColumnFeatures::is_tight_mean)
		.value("is_tight_min", NodeBipartiteCandObs::ColumnFeatures::is_tight_min)
		.value("is_tight_max", NodeBipartiteCandObs::ColumnFeatures::is_tight_max)
		.value("dual_solution_mean", NodeBipartiteCandObs::ColumnFeatures::dual_solution_mean)
		.value("dual_solution_min", NodeBipartiteCandObs::ColumnFeatures::dual_solution_min)
		.value("dual_solution_max", NodeBipartiteCandObs::ColumnFeatures::dual_solution_max)
		.value("scaled_age_mean", NodeBipartiteCandObs::ColumnFeatures::scaled_age_mean)
		.value("scaled_age_min", NodeBipartiteCandObs::ColumnFeatures::scaled_age_min)
		.value("scaled_age_max", NodeBipartiteCandObs::ColumnFeatures::scaled_age_max);

	auto node_bipartite_cand = py::class_<NodeBipartiteCand>(m, "NodeBipartiteCand", R"(
		Bipartite graph observation function on branch-and bound node.

		This observation function extract structured :py:class:`NodeBipartiteCandObs`.
	)");
	node_bipartite_cand.def(py::init<bool>(), py::arg("cache") = false, R"(
		Constructor for NodeBipartiteCand.
	...
	def_before_reset(node_bipartite_cand, "Cache some feature not expected to change during an episode.");
	def_extract(node_bipartite_cand, "Extract a new :py:class:`NodeBipartiteObs`.");
